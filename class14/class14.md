...
Check correspondance of the columns of `counts` and the rows of
`metadata`
...
\##Add annotation \>Q. Use the mapIDs() function multiple times to add
...
```
    ...
    Info: Working in directory C:/Users/sabri/OneDrive/Desktop/BIMM 143/bimm143_github_v3/class14
...
Cell cycle has the most significant “Entities p-value”. It doesn’t match
because it has a slightly different way of calculating.

\#Section 5. GO online (OPTIONAL) \>Q: What pathway has the most
...
Trachea formation has the most significant “Entities p-value”. It
doesn’t match because it has a slightly different way of calculating.
